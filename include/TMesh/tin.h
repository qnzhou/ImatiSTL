...
//		TMESH_VIRTUAL bool isBaseType() const { return true; }
	...
	public:
		...
		/////////////////////////////////////////////////////////////////////////////
		//
		// Primitive Construction (Implemented in "TMesh/tin.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////
		//
		// Primitive Destruction (Implemented in "TMesh/tin.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////
		//
		// Methods acting on selections (Implemented in "TMesh/tin.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////
		//
		// Region manipulation (Implemented in "TMesh/tin.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////
		//
		// Global Operations (Implemented in "TMesh/tin.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		bool isInnerPoint(const Point& p) const;


		/////////////////////////////////////////////////////////////////////////////
		//
		// Surface topology manipulation (Implemented in "TMesh/tin.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////
		//
		// Topological fixes (Implemented in "Algorithms/checkAndRepair.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		TMESH_VIRTUAL bool rebuildConnectivity(bool = true);
		...
		/////////////////////////////////////////////////////////////////////////////
		//
		// Geometrical fixes (Implemented in "Algorithms/checkAndRepair.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////
		//
		// Advanced repairing (Implemented in "Algorithms/detectIntersections.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////
		//
		// Hole triangulation (Implemented in "Algorithms/holeFilling.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		/////////////////////////////////////////////////////////////////////////////
		//
		// Other global algorithms (Implemented in "Algorithms/*.cpp")
		//
		/////////////////////////////////////////////////////////////////////////////
		...
		//! Performs one step of Bender (modified butterfly subdivision)
		void modbutSubdivision();

		//! Performs one step of sqrt3 subdivision
		void sqrt3Subdivision();

		//! Mesh simplification. Scales the mesh down to 'numver' vertices by iterative edge contraction.
		//! If 'check', penalizes contractions that cause triangles to flip.
		//! If 'edgelen', uses the edge length as a cost to prioritize contractions (QEM is used otherwise).
		//! If 'optimal', computes the best position for the representative vertex for each contraction.
		bool simplify(int numver, int optimal, int edgelen, int check);
		...
		bool collapseShortEdges(const double min_squared_length);

		//! Iterative edge swaps to optimize connectivity in flat areas
		bool delaunizeFlatAreas();

		//! Performs 'ns' iterations of laplacian smoothing using a weight = l for neighbors
		void laplacianSmooth(int ns =1, coord l =1.0);

		//! Performs 'ns' iterations of bilateral smoothing
		void bilateralSmooth(int ns = 1);

		//! Performs 'numits' spherization iterations (rounds highly curved areas)
		int spherize(int numits);

		//! Detects planar regions and tags their border edges as 'sharp'.
		//! A region is planar if all its points are within 'max_distance' to their best fitting plane.
		void tagPlanarRegionsBoundaries(double max_distance);

		//! EdgeSharpener: recovers sharp edges on chamfered triangles.
		int featureRecover(double ang, double edge_mult);
